        ...
        <div class="main-body">
            <div>
                ...
                <div class=" justify-content-md-end">
                    <a href="{{route('admin.posts.index')}}" class="btn btn-secondary btn-lg" tabindex="-1" role="button" aria-disabled="true">Back</a>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <button onclick="editPost({{ $post->id }})" class="btn btn-success" type="button">Update</button>
                            </ul>
                        </div>
                    </div>
                </div>
